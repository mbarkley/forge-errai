...
public class ErraiCdiExample extends ErraiExample{
    ...
    void createWebappFiles(final PipeOut pipeOut) {
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "WEB-INF/beans.xml", "file"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "WEB-INF/jetty-env.xml", "file"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "index.html", "file"));
    ...
    void createAppFiles(final PipeOut pipeOut) {
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "App", "class"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "HelloMessage", "class"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "Response", "class"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "SimpleCDIService", "class"));
    ...
    void createResourceFiles(final PipeOut pipeOut) {
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "login.config", "file"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "roles.properties", "file"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "users.properties", "file"));
    }    
    ...
    void createTestFiles(final PipeOut pipeOut) {
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "jndi.properties", "file"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "AppIntegrationTest.java", "class"));
        ...
        pipeOut.println(ShellColor.YELLOW, String.format(ErraiFacet.SUCCESS_MSG_FMT, "CDITestHelper.java", "class"));
    }
