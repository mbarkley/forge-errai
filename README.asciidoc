...
.Published Versions
====
Not all versions of the Errai Addon are in Maven Central. If you wish to install a version such as a SNAPSHOT you will need to build the version yourself.

To download and build the latest version of this plugin, run:
[code]
----
